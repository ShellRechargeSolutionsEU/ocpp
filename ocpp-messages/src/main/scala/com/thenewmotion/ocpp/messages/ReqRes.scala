...
object ReqRes {
  implicit object RemoteStartTransactionReqRes extends ChargePointReqRes[RemoteStartTransactionReq, RemoteStartTransactionRes] {
    ...
    def applyAsync(req: RemoteStartTransactionReq)(implicit service: ChargePoint, ec: ExecutionContext) = service.remoteStartTransaction(req)
  }
  ...
  implicit object RemoteStopTransactionReqRes extends ChargePointReqRes[RemoteStopTransactionReq, RemoteStopTransactionRes] {
    ...
    def applyAsync(req: RemoteStopTransactionReq)(implicit service: ChargePoint, ec: ExecutionContext) = service.remoteStopTransaction(req)
  }
  ...
  implicit object UnlockConnectorReqRes extends ChargePointReqRes[UnlockConnectorReq, UnlockConnectorRes] {
    ...
    def applyAsync(req: UnlockConnectorReq)(implicit service: ChargePoint, ec: ExecutionContext) = service.unlockConnector(req)
  }
  ...
  implicit object GetDiagnosticsReqRes extends ChargePointReqRes[GetDiagnosticsReq, GetDiagnosticsRes] {
    ...
    def applyAsync(req: GetDiagnosticsReq)(implicit service: ChargePoint, ec: ExecutionContext) = service.getDiagnostics(req)
  }
  ...
  implicit object ChangeConfigurationReqRes extends ChargePointReqRes[ChangeConfigurationReq, ChangeConfigurationRes] {
    ...
    def applyAsync(req: ChangeConfigurationReq)(implicit service: ChargePoint, ec: ExecutionContext) = service.changeConfiguration(req)
  }
  ...
  implicit object GetConfigurationReqRes extends ChargePointReqRes[GetConfigurationReq, GetConfigurationRes] {
    ...
    def applyAsync(req: GetConfigurationReq)(implicit service: ChargePoint, ec: ExecutionContext) = service.getConfiguration(req)
  }
  ...
  implicit object ChangeAvailabilityReqRes extends ChargePointReqRes[ChangeAvailabilityReq, ChangeAvailabilityRes] {
    ...
    def applyAsync(req: ChangeAvailabilityReq)(implicit service: ChargePoint, ec: ExecutionContext) = service.changeAvailability(req)
  }
  ...
  implicit object SendLocalListReqRes extends ChargePointReqRes[SendLocalListReq, SendLocalListRes] {
    ...
    def applyAsync(req: SendLocalListReq)(implicit service: ChargePoint, ec: ExecutionContext) = service.sendLocalList(req)
  }
  ...
  implicit object GetLocalListVersionReqRes extends ChargePointReqRes[GetLocalListVersionReq.type, GetLocalListVersionRes] {
    ...
    def applyAsync(req: GetLocalListVersionReq.type)(implicit service: ChargePoint, ec: ExecutionContext) = service.getLocalListVersion
  }
  ...
  implicit object ChargePointDataTransferReqRes extends ChargePointReqRes[ChargePointDataTransferReq, ChargePointDataTransferRes] {
    ...
    def applyAsync(req: ChargePointDataTransferReq)(implicit service: ChargePoint, ec: ExecutionContext) = service.dataTransfer(req)
  }
  ...
  implicit object CancelReservationReqRes extends ChargePointReqRes[CancelReservationReq, CancelReservationRes] {
    ...
    def applyAsync(req: CancelReservationReq)(implicit service: ChargePoint, ec: ExecutionContext) = service.cancelReservation(req)
  }
  ...
  implicit object ClearChargingProfileReqRes extends ChargePointReqRes[ClearChargingProfileReq, ClearChargingProfileRes] {
    ...
    def applyAsync(req: ClearChargingProfileReq)(implicit service: ChargePoint, ec: ExecutionContext) = service.clearChargingProfile(req)
  }
  ...
  implicit object GetCompositeScheduleReqRes extends ChargePointReqRes[GetCompositeScheduleReq, GetCompositeScheduleRes] {
    ...
    def applyAsync(req: GetCompositeScheduleReq)(implicit service: ChargePoint, ec: ExecutionContext) = service.getCompositeSchedule(req)
  }
  ...
  implicit object SetChargingProfileReqRes extends ChargePointReqRes[SetChargingProfileReq, SetChargingProfileRes] {
    ...
    def applyAsync(req: SetChargingProfileReq)(implicit service: ChargePoint, ec: ExecutionContext) = service.setChargingProfile(req)
  }
  ...
  implicit object TriggerMessageReqRes extends ChargePointReqRes[TriggerMessageReq, TriggerMessageRes] {
    ...
    def applyAsync(req: TriggerMessageReq)(implicit service: ChargePoint, ec: ExecutionContext) = service.triggerMessage(req)
  }
  ...
  implicit object StartTransactionReqRes extends CentralSystemReqRes[StartTransactionReq, StartTransactionRes] {
    ...
    def applyAsync(req: StartTransactionReq)(implicit service: CentralSystem, ec: ExecutionContext) = service.startTransaction(req)
  }
  ...
  implicit object StopTransactionReqRes extends CentralSystemReqRes[StopTransactionReq, StopTransactionRes] {
    ...
    def applyAsync(req: StopTransactionReq)(implicit service: CentralSystem, ec: ExecutionContext) = service.stopTransaction(req)
  }
  ...
  implicit object BootNotificationReqRes extends CentralSystemReqRes[BootNotificationReq, BootNotificationRes] {
    ...
    def applyAsync(req: BootNotificationReq)(implicit service: CentralSystem, ec: ExecutionContext) = service.bootNotification(req)
  }
  ...
  implicit object CentralSystemDataTransferReqRes extends CentralSystemReqRes[CentralSystemDataTransferReq, CentralSystemDataTransferRes] {
    ...
    def applyAsync(req: CentralSystemDataTransferReq)(implicit service: CentralSystem, ec: ExecutionContext) = service.dataTransfer(req)
  }
